    ...
    <div class=" service pb-5">
        <div class="col-lg-12">
            <div class="resolutions-section-title d-flex align-items-center justify-content-center">
                ...
                <!-- Título centrado -->
                <h2 class="sub-t mb-0 flex-grow-1 text-center">Calendario Academico UATF</h2>
            </div>
        </div>
            ...
            <div class="year-selector">
                ...
                <select id="yearDropdown"  onchange="location = this.value;">
                    @foreach($years as $year)
                        <option value="{{ route('pages.calendar', $year) }}" {{ $currentYear == $year ? 'selected' : '' }}>
                            {{ $year }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row curricular-menu-curricular-container" id="circulares-container">
            @include('partials.calendar', ['calendars' => $calendars])
