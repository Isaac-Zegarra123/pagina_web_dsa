...
.curved-title {
    ...
    font-weight: bold;
    text-align: center;
    margin-bottom: 30px; /* Espacio mayor entre el título y la imagen */
    text-transform: uppercase;
    text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2); /* Sombra más visible */
    letter-spacing: 3px;
    line-height: 1.2;
}
...
.circle {
    width: 500px; /* Imagen más pequeña */
    height: 500px;
    margin: 0 auto;
    border-radius: 50%;
    overflow: hidden;
    border: 5px solid #003366; /* Azul oscuro */
    display: flex;
...
@media (max-width: 768px) {
    .curved-title {
        font-size: 2.5rem; /* Reduce el tamaño del título en pantallas más pequeñas */
        margin-bottom: 20px;
    }

    .circle {
        width: 100px; /* Reduce el tamaño de la imagen en pantallas más pequeñas */
        height: 100px;
    }
...
@media (max-width: 480px) {
    ...
    .circle {
        width: 90px; /* Ajusta aún más el tamaño de la imagen */
        height: 90px;
    }
}
</style>
...
@section('content')
<div class="container">
    <h1 class="curved-title">Dirección de Servicios Académicos</h1>
    <div class="circle">
        <img src="{{ asset('images/logo_oficial.png') }}" alt="Imagen de servicios académicos">
    </div>
</div>
@stop
