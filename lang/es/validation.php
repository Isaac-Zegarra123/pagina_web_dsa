...
return [
    ...
    | estos mensajes según sea necesario.
    |
    */
    ...
    | utilizando la convención "attribute.rule" para nombrar las líneas. Esto te permite
    | especificar un mensaje de lenguaje personalizado específico para una regla de atributo
    | dada.
    |
    */
    ...
    | marcadores de posición de atributo por algo más amigable para el lector,
    | como "Dirección de correo electrónico" en lugar de "email". Esto simplemente
    | nos ayuda a hacer que nuestro mensaje sea un poco más claro.
    |
    */
